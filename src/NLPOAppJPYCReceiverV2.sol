...
/**
 * @title NLPOAppJPYCReceiverV2
 * @author NewLo Team
 * @notice LayerZero OApp receiver for handling JPYC exchange requests (V2 - Self-Custody)
 ...
 */
contract NLPOAppJPYCReceiverV2 is OApp, ReentrancyGuard {
    ...
    /**
     * @notice Initialize the NLPOAppJPYCReceiverV2
